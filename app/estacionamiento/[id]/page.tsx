...
export default function DetalleEstacionamiento() {
  ...
  useEffect(() => {
    const fetchEstacionamiento = async () => {
      ...
      try {
        const docRef = doc(db, "estacionamientos", params.id as string)
        ...
        if (docSnap.exists()) {
          ...
          console.log("No existe el estacionamiento")
        ...
        toast({
          variant: "destructive",
          title: "Error",
          description: "Error al cargar los detalles del estacionamiento",
        })
        router.push("/buscar-estacionamiento")
      } finally {
        setLoading(false)
  ...
  if (loading) {
    return (
      <div className="container mx-auto py-10 text-center">
        <p>Cargando detalles del estacionamiento...</p>
      </div>
    )
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
            ...
            {/* Botón para chatear - no visible si el usuario es el propietario */}
            {!esPropietario && (
              <Button
                variant="outline"
